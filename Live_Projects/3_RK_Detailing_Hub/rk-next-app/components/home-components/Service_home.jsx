...
const Service_home = () => {
  ...
  return (
    <div className="m-2 md:m-10 mt-10  text-center  ">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 mt-10 md:mt-14 m-4 gap-6 md:gap-10
      ...
      <div className='bg-white text-gray-500 h-36 w-full rounded-xl mt-10 grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-5 p-3 md:p-10  shadow-md shadow-cyan-200'>
        ...
        <div className="flex justify-center items-center gap-3">
          ...
          <div className="">
            <h1 className="text-lg md:text-3xl font-bold">100+</h1>
            <p className=" text-sm md:text-lg font-semibold">Projects Completed</p>
          </div>
        </div>
