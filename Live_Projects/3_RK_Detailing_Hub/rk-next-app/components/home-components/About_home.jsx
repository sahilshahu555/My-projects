    ...
    <div className='mt-10 md:mt-16 'id='ABOUT'>
      ...
      <div className='flex flex-col md:flex-row justify-around gap-3 md:gap-10 mt-2  md:mt-8 '>
        ...
        <div className='w-full md:w-1/2 p-5 text-start flex flex-col gap-5 '>
          <h1 className='text-gray-500  font-[900] md:font-bold text-2xl text-center md:text-4xl w-full '>Car Washing And Detailing</h1>
