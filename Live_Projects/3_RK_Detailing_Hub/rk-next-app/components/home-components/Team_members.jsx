...
const Team_members = () => {
  return (
    <div className='mt-10 md:mt-10 text-center'>
     <p className='text-cyan-400 text-xl font-bold  '>MEET OUR OWNER</p>
      
     
        <div className='grid grid-cols-1 md:grid-cols-1 gap-5 p-2 md:gap-5  md:p-5 text-white'>

          <div className='bg-cyan-400 shadow-lg shadow-gray-400 w-56 m-auto'>
