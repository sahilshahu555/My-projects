...
const Navbar = () => {
  ...
  return (
    <div className="flex gap-16 items-center justify-around md:justify-center font-bold  text-black  p-5 lg:mx-20 mx-0  bg-gradient-to-r from-red-300 to-orange-300   rounded-xl mb-10 h-14 ">
